...
int main() {
	printf("Number:2019556466\n");
	printf("Name:emin enes buyuran\n");
	clock_t t;

	//InsertionSort
	int arr[] = { 2,0,1,9,5,5,6,4,5,6};
	int n = sizeof(arr) / sizeof(arr[0]);
	char name[] = "emin enes buyuran";
	...
	//SelectionSort
	int arr1[] = { 2,0,1,9,5,5,6,4,6,6};
	int n1 = sizeof(arr) / sizeof(arr1[0]);
	char name1[] = "emin enes buyuran";
	...
	//MergeSort
	int arr2[] = { 2,0,1,9,5,5,6,4,6,6};
	int n2 = sizeof(arr) / sizeof(arr2[0]);
	char name2[] = "emin enes buyuran";
	...
	//BubbleSort
	int arr3[] = { 2,0,1,9,5,5,6,4,6,6};
	int n3 = sizeof(arr) / sizeof(arr3[0]);
	char name3[] = "emin enes buyuran";
