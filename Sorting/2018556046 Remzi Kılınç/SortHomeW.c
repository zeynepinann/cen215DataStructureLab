...
int main() {
	printf("School Number: 2018556046\n");
	printf("Name: Remzi Kilinc\n");
	clock_t t;

	//InsertionSort
	int arr[] = { 2,0,1,8,5,5,6,0,4,6 };
	int n = sizeof(arr) / sizeof(arr[0]);
	char name[] = "remzi kilinc";
	...
	//SelectionSort
	int arr1[] = { 2,0,1,8,5,5,6,0,4,6 };
	int n1 = sizeof(arr) / sizeof(arr1[0]);
	char name1[] = "remzi kilinc";
	...
	//MergeSort
	int arr2[] = { 2,0,1,8,5,5,6,0,4,6 };
	int n2 = sizeof(arr) / sizeof(arr2[0]);
	char name2[] = "remzi kilinc";
	...
	//BubbleSort
	int arr3[] = { 2,0,1,8,5,5,6,0,4,6 };
	int n3 = sizeof(arr) / sizeof(arr3[0]);
	char name3[] = "remzi kilinc";
