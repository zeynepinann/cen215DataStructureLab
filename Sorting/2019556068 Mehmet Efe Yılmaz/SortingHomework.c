...
main()
{
    ...
    printf("\n\nIt took %.15f seconds to sort arrays with Insertion Sort\n\n",
        time_taken1);
    ...
    printf("\n\nIt took %.15f seconds to sort arrays with Selection Sort\n\n",
        time_taken2);
    ...
    printf("\n\nIt took %.15f seconds to sort arrays with Bubble Sort\n\n",
        time_taken3);
    ...
    printf("\n\nIt took %.15f seconds to sort arrays with Merge Sort\n\n",
        time_taken4);
	...
	printf("\n\nIt took %.15lf seconds to sort arrays with Quick Sort\n\n", time_taken5);
	...
	printf("\n\nIt took %.15lf seconds to sort arrays with Heap Sort\n\n", time_taken6);
